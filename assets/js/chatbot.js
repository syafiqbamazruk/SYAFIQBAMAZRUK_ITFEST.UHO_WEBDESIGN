        ...
        const faqData = [
            ...
            // 🔹 Info perusahaan
            {
                ...
                response: "Nama perusahaan kami adalah UangPintar dibuat oleh Syafiq Bamazruk dalam Partisipasi Lomba Web Design Intechfest."
            }, {
                ...
                response: "Anda bisa menghubungi kami melalui WhatsApp, email, atau halaman kontak di website UangPintar."
            }, {
            ...
            // 🔹 Keyword umum
            {
                ...
                response: `Berikut fitur-fitur UangPintar: 
...
4. Kalkulator Investasi Cerdas`
                ...
                response: "Saya adalah chatbot UangPintar 🤖 yang diciptakan oleh Syafiq Bamazruk, siap membantu Anda dalam hal edukasi finansial."
            }
        ];
        ...
        function getResponse(userInput) {
            ...
            if (emojiOnly.test(userInput)) {
                return `${userInput} Mantap emotenya! Ada pertanyaan seputar UangPintar yang bisa saya bantu?`;
            }
            ...
            return "Maaf, saya tidak mengerti pertanyaan Anda. Silakan bertanya seputar UangPintar.";
        }
